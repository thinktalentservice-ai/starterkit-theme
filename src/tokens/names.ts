...
export const TOKENS_VERSION = "9451b3ea404a";

/** Every custom property a brand must define on `:root`. 205 names. */
export const ROOT_TOKEN_NAMES = [
  ...
  "--accent-green",
  "--accent-green-solid",
  "--accent-green-solid-hover",
  "--accent-green-on-solid",
  "--accent-green-bg",
  "--accent-green-border",
  "--accent-green-channel",
  "--accent-pink-text",
  "--accent-pink",
  "--accent-pink-solid",
  "--accent-pink-solid-hover",
  "--accent-pink-on-solid",
  "--accent-pink-bg",
  "--accent-pink-border",
  "--accent-pink-channel",
  "--fg-muted",
  ...
  "--shadow-btn-danger",
  "--shadow-btn-info",
  "--shadow-btn-accent-green",
  "--shadow-btn-accent-pink",
  "--gradient-primary",
  "--gradient-secondary",
  "--gradient-accent",
  "--gradient-success",
...
/** Custom properties the light scheme declares. 100 names,
 *  of which 100 actually differ from their `:root` value. */
...
export const CHANNEL_PAIRS: ReadonlyArray<readonly [string, string]> = [
  ...
  ["--info-channel", "--info"],
  ["--accent-green-channel", "--accent-green"],
  ["--accent-pink-channel", "--accent-pink"],
