/* SOLSTICE — a client hue on Obsidian's own ramp geometry.
 *
...
const FAMILIES = {
  ...
  mint: { ...OBSIDIAN.families.mint!, seed: "#C2410C", darkFollow: { "--mint-dark": "--mint" } },
  electric: { ...OBSIDIAN.families.electric!, seed: "#0F766E" },
  amber: OBSIDIAN.families.amber!,
  cobalt: OBSIDIAN.families.cobalt!,
  rose: OBSIDIAN.families.rose!,
  sky: OBSIDIAN.families.sky!,
  cyan: { ...OBSIDIAN.families.cyan!, seed: "#EA580C" },
};

const NEUTRAL_DARK = { seed: "#1A1512", slots: OBSIDIAN.neutral.dark.slots };
const NEUTRAL_LIGHT = { seed: "#FAF7F2", slots: OBSIDIAN.neutral.light.slots };

const TOKENS: Record<string, TokenRule> = {
  ...OBSIDIAN.tokens,
  "--font-heading": literal("'Fraunces', Georgia, serif"),
  "--font-body": literal("'Source Sans 3', system-ui, sans-serif"),
};
...
export const SOLSTICE: PresetSpec = {
  id: "solstice",
  name: "Solstice",
  intensity: 0.2,
  radius: 4,
